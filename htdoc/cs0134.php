...
<html lang="en">
  ...
  <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <?php include_once "./includes/0134/0134intro.php"; ?>    

    <?php include_once "./includes/0134/0134course_info.php"; ?>

    <?php include_once "./includes/instructor_info.php"; ?>

    <?php include_once "./includes/0134/0134ta_info.php"; ?>

    <?php include_once "./includes/0134/0134announcements.php"; ?>

    <?php include_once "./includes/0134/0134syllabus.php"; ?>

    <?php include_once "./includes/0134/0134in_class.php"; ?>

    <?php include_once "./includes/0134/0134materials.php"; ?>

    <?php include_once "./includes/0134/0134handouts.php"; ?>

    <?php include_once "./includes/0134/0134projects.php"; ?>

    <?php include_once "./includes/0134/0134links.php"; ?>
