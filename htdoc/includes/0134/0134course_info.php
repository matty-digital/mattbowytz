  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <ul>
          <li>Some good ones are:</li>
          <li class="l-ten b-five">
          ...
          <li class="l-ten b-five">
            <a href="https://www.jetbrains.com/phpstorm/buy/#edition=discounts" target="_blank">PhpStorm (free with student email)</a>
          </li>
          <li class="l-ten b-five">
            <a href="https://www.jetbrains.com/webstorm/buy/#edition=discounts" target="_blank">WebStorm (free with student email)</a>
          </li>
          <li>
            Friends don't let friends use DreamWeaver. It will make me cry if you use it. I'm an ugly crier...nobody wants to see that.
          </li>
        </ul>
        <p>
      ...
      <div class="col-lg-12">
        ...
        <ul>
          ...
          <li class="b-five">
            To earn full credit, assignments MUST be handed in on time. See the <b>Course Policies</b> section below.
          </li>
          <li class="b-five">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <ul>
          ...
          <li class="b-five">
            Late Work: Believe it or not, all of you work must be submitted on time. This usually means at ot brfore 11:59pm on the day it's due. The system works like this: 1 class late - 25% off. 2 classes late - 50% off. 3 classes late - you can just keep it, no credit will be given.
          </li>
          <li class="b-five">
          ...
          <li class="b-five">
            Students with Disabilities: If you have a disability for which you are or may be requesting an accommodation, you are encouraged to contact both your myself and Disability Resources and Services, 216 William Pitt Union, 412-648-7890 or 412-383-7355 (TTY) as early as possible in the term. DRS will verify your disability and determine reasonable accommodations for this course. More info <a href="http://www.studentaffairs.pitt.edu/drswelcome">here</a>
          </li>
        </ul>
      </div>
      <span class="glyphicon glyphicon-star-empty block centered b-ten"></span>
