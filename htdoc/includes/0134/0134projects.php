  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 centered">
        ...
        <p class="med red-txt bold">Proposal for Part 2</p>
        <ul>
          <li>Professionally written</li>
          <li>Must be submitted in the form of a GitHub gist</li>
          <li>Outline the following:</li>
          <ul>
            <li>What do you plan on doing for part 2</li>
            <ul>
              <li>Are you going to make your part one better? - if so, how?</li>
              <li>Making a completely new site? That's fine too, tell me about it!</li>
            </ul>
            <li>What do you want to implement based on what we've learned and what we will learn?</li>
            <li>Styling yourself or using a CSS framework?</li>
            <li>What have you learned/improved on since part one?</li>
            <li>Include your name, email and CS0134</li>
          </ul>
          <li>I will not accept anything that looks like it was slapped together in 5 seconds because you forgot to do it.</li>
          <li>Let me know if you have any questions!</li>
        </ul>
        <span class="glyphicon glyphicon-star-empty block centered b-ten"></span>
        <p class="med red-txt bold">Improved Project Part 1 OR New Project</p>
        <ul>
          <li>Dynamic Site</li>
          <li>Minimum 3 linked pages</li>
          <li>Pages can be whatever you need them to be for the project</li>
          <li>Use of semantic HTML5</li>
          <li>Use of at least 3 advanced CSS3 techniques</li>
          <ul>
            <li>Transitions</li>
            <li>Animations</li>
            <li>Etc.</li>
          ...
          <li>By the time this project is due, you will have learned everything you need to complete the requirements</li>
          <li>Please don't hesitate to ask if you have <b>ANY</b> questions about this project</li>
          <li>Grading Rubric will be the same as part 1</li>
        </ul>
      </div>
      <span class="glyphicon glyphicon-star-empty block centered b-ten"></span>
      <div class="col-lg-12 centered">
        ...
        <span class="glyphicon glyphicon-star-empty block centered b-ten"></span>
        <p class="med red-txt bold">Proposal for Part 1</p>
        <ul>
        	<li>Professionally written</li>
        	<li>Must be submitted in the form of a GitHub gist</li>
        	<li>Outline the following:</li>
        	<ul>
        		...
        		<li>How do you plan on using our tech stack?</li>
        		<li>Styling yourself or using a CSS framework?</li>
        		<li>Include your name, email and all that good stuff</li>
        	</ul>
        	<li>I will not accept anything that looks like it was slapped together in 5 seconds because you forgot to do it.</li>
        	<li>Let me know if you have any questions!</li>
        </ul>
        <span class="glyphicon glyphicon-star-empty block centered b-ten"></span>
        <p class="med red-txt bold">Mock Commerce Web Site</p>
        <ul>
        	<li>Static Site</li>
        	<li>Minimum 3 linked pages</li>
        	<ul>
        		<li>Home Page</li>
        		<li>Product Index Page (at least 6 items)</li>
        		<li>Cart Page</li>
        	</ul>
        	<li>Use of semantic HTML5</li>
        	<li>Use of at least 3 advanced CSS3 techniques</li>
      ...
      <span class="glyphicon glyphicon-star-empty block centered b-ten"></span>
      <div class="col-lg-12 centered">
        <p class="med uc red-txt bold">Grading Rubric</p>
        <ul>
          <li>
